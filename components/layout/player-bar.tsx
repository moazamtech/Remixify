    ...
    return (
        <div className="h-24 bg-black border-t border-zinc-800/50 px-4 flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4 min-w-[180px] w-[30%]">
                ...
                <Button variant="ghost" size="icon" className="text-zinc-400 hover:text-white ml-2 hidden sm:flex">
            ...
            <div className="flex flex-col items-center gap-2 max-w-[40%] w-full">
                <div className="flex items-center gap-6">
                    ...
                    <Button variant="ghost" size="icon" className="text-zinc-400 hover:text-white" onClick={() => onSeek(0)}>
                    ...
                    <Button variant="ghost" size="icon" className="text-zinc-400 hover:text-white" onClick={() => onSeek(duration)}>
            ...
            <div className="flex items-center justify-end gap-3 min-w-[180px] w-[30%]">
                <Button variant="ghost" size="icon" className="text-zinc-400 hover:text-white hidden md:flex">
                    <Mic2 className="w-4 h-4" />
                </Button>
                <Button variant="ghost" size="icon" className="text-zinc-400 hover:text-white hidden md:flex">
                    <ListMusic className="w-4 h-4" />
                </Button>
                <Button variant="ghost" size="icon" className="text-zinc-400 hover:text-white hidden lg:flex">
